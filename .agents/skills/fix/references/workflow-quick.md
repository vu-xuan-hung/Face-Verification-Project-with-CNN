...
### Step 3: Verify
Use `code_reviewer` subagent for quick review.
...
**If autonomous mode:** Ask to commit via `git_manager` subagent if score >= 9.0
...
- Parallel `git_manager` - Verification (Step 2)
- `code_reviewer` subagent - Always (Step 3)
