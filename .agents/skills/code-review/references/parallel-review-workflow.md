...
**Ultrathink** to exhaustively list ALL potential edge cases, then dispatch parallel `code_reviewer` agents to verify: <scope>$ARGUMENTS</scope>
...
- Ask: "Commit? [Y/n]" → use `git_manager`
