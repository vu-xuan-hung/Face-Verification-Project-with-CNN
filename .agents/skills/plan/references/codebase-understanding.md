...
1. **`./.codex/rules/development-rules.md`** (IMPORTANT)
...
2. **the configured `Docs:` path `codebase-summary.md`**
   - Project structure and current status
   - High-level architecture overview
   - Component relationships

3. **the configured `Docs:` path `code-standards.md`**
   - Coding conventions and standards
   - Language-specific patterns
   - Naming conventions

4. **the configured `Docs:` path `design-guidelines.md`** (if exists)
