...
- Engage the `docs_manager` agent to understand existing project implementation and constraints
- Use `available web search` tool to find efficient approaches and learn from others' experiences
