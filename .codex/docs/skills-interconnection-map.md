...
CodexKit's skill system is designed as an **interconnected ecosystem** — not a collection of isolated tools. Skills call each other, delegate subtasks, and compose workflows automatically.
