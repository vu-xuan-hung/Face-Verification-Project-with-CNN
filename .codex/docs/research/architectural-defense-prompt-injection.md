...
Một paper tháng 10/2025 từ team 14 researchers (bao gồm thành viên từ OpenAI, OpenAI, Google DeepMind) đã test 12 defense mechanisms phổ biến nhất — **tất cả đều bị bypass với tỷ lệ >90%** khi attacker dùng adaptive attacks (gradient-based, reinforcement learning, search-based).
...
Dựa trên yêu cầu của user, tạo execution plan dưới dạng JSON:
{
  "steps": [
    ...
    {"tool": "write_file", "params": {"path": "/home/codex/output.csv"}}
  ]
}
...
## Privileged LLM (main Codex instance)
...
- [ ] Không truy cập ngoài /home/codex/ và input file
...
- Read-only filesystem (trừ /home/codex/output/)
- No network access
...
## Áp Dụng Cụ Thể Cho Codex Skill System
...
2. Nasr et al. (2025). "The Attacker Moves Second: Stronger Adaptive Attacks Bypass Defenses Against LLM Jailbreaks and Prompt Injections" — OpenAI, OpenAI, Google DeepMind  
