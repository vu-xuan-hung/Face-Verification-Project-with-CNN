...
**Skill Organization** (`.codex/skills/`):
...
**Organized by Domain** (`.codex/skills/`):
...
**FR2: Command System**
- Parse skill commands with arguments
...
3. **Custom AI Model Support**: Should we support other AI platforms beyond Codex and OpenRouter?
