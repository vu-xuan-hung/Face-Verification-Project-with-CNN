# Codex Task Management trong CodexKit Skills

Tài liệu này mô tả chi tiết cách các skills của CodexKit sử dụng Codex Task Management để theo dõi tiến độ, điều phối subagents, và quản lý workflows phức tạp.

## Tổng quan

Codex cung cấp 4 native tools để quản lý tasks trong session:
