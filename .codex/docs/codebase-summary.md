...
CodexKit is a comprehensive boilerplate template for building professional software projects with CLI Coding Agents (Codex and Open Code). It provides a complete development environment with AI-powered agent orchestration, automated workflows, and intelligent project management.
...
- **AGENTS.md**: Development instructions and workflows
...
- **.codex/rules/**: Development rules and protocols
...
Script: `.codex/hooks/send-discord.sh`
...
### Workflows
- `.codex/rules/primary-workflow.md`
- `.codex/rules/development-rules.md`
- `.codex/rules/orchestration-protocol.md`
- `.codex/rules/documentation-management.md`

## Related Projects

- **codexkit** - CodexKit website (`../codexkit`)
- **codexkit-marketing** - Marketing Kit (`../codexkit-marketing`)
- **codexkit-cli** - CLI setup tool (`../codexkit-cli`)
- **codexkit-docs** - Public docs (`../codexkit-docs`)
